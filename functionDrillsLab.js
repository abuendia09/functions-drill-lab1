...
const biggerNums = compareNums (10,7)
...
let nameGreeting = nameCheck('Joey')
...
function chocoFrogos(gold) {
  return gold / 3
  // return amount frogs I can purchase
}
const totalFrogs = chocoFrogos(20)
...
let totalFrogs2 = chocoFrogos2(100)
